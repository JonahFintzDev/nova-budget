  ...
  <div class="relative flex min-h-dvh items-center justify-center overflow-hidden bg-bg px-4">
    ...
    >
      ...
      <div class="mb-7 flex flex-col items-center gap-3">
        <img src="/icon.svg" alt="Nova Budget logo" class="h-14 w-14 drop-shadow-sm" />
        <div class="text-center">
          <h1 class="text-2xl font-bold tracking-tight text-text-primary">Nova Budget</h1>
          <p class="mt-0.5 text-sm text-text-muted">Your personal budget tracker</p>
        </div>
      </div>
