...
const STORAGE_KEY = 'nova-budget-notifications-enabled';
...
const extractKeys = (sub: PushSubscription): { p256dh: string; auth: string } | null => {
...
export const syncPushSubscription = async (enabled: boolean): Promise<void> => {
