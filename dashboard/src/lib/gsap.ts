...
export const modalTransitionEnter = (el: Element, done: () => void): void => {
...
export const modalTransitionLeave = (el: Element, done: () => void): void => {
  if (prefersReducedMotion()) {
    done();
    return;
  }
...
export const pageEnter = (el: Element, done: () => void): void => {
  if (prefersReducedMotion()) {
    done();
    return;
  }
...
export const pageLeave = (el: Element, done: () => void): void => {
  if (prefersReducedMotion()) {
    done();
    return;
  }
...
export const fadeInElement = (el: HTMLElement | null): void => {
